<footer class="shadow grid col-start-2 col-end-7 row-start-7 items-center w-full sm:p-6 dark:bg-gray-800 mt-5 py-4">
    <div class="flex justify-between pb-0.5">
        <p class="text-sm justify-center text-center dark:text-gray-400 sm:mb-0 mt-2">
            &copy; 2023 <a href="#" class="hover:underline" target="_blank"> SManager.com</a>. All rights reserved.
        </p>
