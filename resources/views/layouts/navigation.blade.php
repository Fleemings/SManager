            ...
            <div class="flex items-center my-4 shadow-md  p-2 justify-between">
                ...
                <div class="relative mt-1">
                    ...
                    <form action="{{ route('search.index') }}" method="GET">
                        <input id="table-search" name="search" class="block p-2 pl-10 text-sm rounded-lg w-80 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search for items" />
                    </form>
                </div>
            </div>
                ...
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        ...
                        <form method="POST" action="{{ route('logout') }}">
                            ...
                            <x-dropdown_link :href="route('logout')" onclick="event.preventDefault();
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            ...
            <div class="mt-3 space-y-1">
                ...
                <form method="POST" action="{{ route('logout') }}">
                    ...
                    <x-responsive_nav_link :href="route('logout')" onclick="event.preventDefault();
                                        this.closest('form').submit();">
                        {{ __('Log Out') }}
                    </x-responsive_nav_link>
                </form>
