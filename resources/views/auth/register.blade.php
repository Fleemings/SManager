<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <!-- Name -->
        <div>
            <x-input_label for="name" :value="__('Name')" />
            <x-text_input id="name" class="block mt-1 w-full" type="text" name="name" :value="old('name')" required autofocus autocomplete="name" />
        ...
        <div class="mt-4">
            ...
            <x-text_input id="email" class="block mt-1 w-full" type="email" name="email" :value="old('email')" required autocomplete="username" />
        ...
        <!-- Confirm Password -->
        <div class="mt-4">
            <x-input_label for="password_confirmation" :value="__('Password confirmation')" />
